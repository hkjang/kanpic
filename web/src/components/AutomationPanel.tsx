...
export function AutomationPanel({workbookId,workbookVersion,sheets,activeSheetId,selectionRange,prepareExecution,onClose,onExecuted}:Props){
  ...
  const automations=useQuery({queryKey:['automations',workbookId],queryFn:()=>api<{items:Automation[]}>(`/api/v1/workbooks/${workbookId}/automations`),refetchInterval:15_000})
