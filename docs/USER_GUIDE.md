...
- 편집기가 다루는 시트는 **200,000행 × 500열** 입니다. 이름 상자에 `A150000` 처럼 입력하면 그 자리로 이동해 바로 편집할 수 있습니다. 행 머리글은 보이는 행 번호의 자릿수에 맞춰 넓어집니다.
- CSV·XLSX 가져오기는 한 번에 최대 **1,000,000셀**(업로드 20MB)까지 받습니다. 15만 행 × 3열짜리 CSV(3.5MB)는 2.5초에 들어옵니다.
