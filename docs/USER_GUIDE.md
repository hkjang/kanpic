...
- `Ctrl/⌘ + F` 또는 `Ctrl/⌘ + K`: 현재 워크북의 모든 시트에서 값과 수식을 검색합니다.
...
## 15. 개인화 설정 및 개인 API 키 (`/preferences`)

### 15.1 테마 및 개인화
- `/preferences` 페이지에서 화면 테마(Light/Dark/System)를 설정할 수 있습니다.

### 15.2 개인 API 키 (Personal API Keys) 발급
