...
만든 덱은 워크북에 매입니다. 워크북을 볼 수 있는 사람만 그 덱을 내려받을 수 있고, 원본 범위와 그때의 워크북 버전이 함께 기록되므로 나중에 자료가 바뀌었는지 알 수 있습니다.
...
## 17. 개인화 설정 및 개인 API 키 (`/preferences`)

### 17.1 테마 및 개인화
- `/preferences` 페이지에서 화면 테마(Light/Dark/System)를 설정할 수 있습니다.

### 17.2 개인 API 키 (Personal API Keys) 발급
