...
func supportedGatewayTool(name string) bool {
	...
	case "create_chart", "update_chart", "create_report_sheet", "create_conditional_format", "create_pivot", "create_data_validation":
		return true
	default:
		return false
	}
