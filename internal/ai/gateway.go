...
func supportedGatewayTool(name string) bool {
	...
	case "create_chart", "update_chart", "create_report_sheet", "create_conditional_format", "create_pivot":
		return true
	default:
		return false
	}
