...
func conditionalFormatSchema(create bool) map[string]any {
	...
	properties := map[string]any{
		...
		"range":                 map[string]any{"type": "string"},
		"rule_type":             map[string]any{"type": "string", "enum": []string{"value", "duplicate", "color_scale", "data_bar", "custom_formula", "rank", "icon_set"}},
		"operator":              map[string]any{"type": "string", "enum": []string{"equals", "not_equals", "greater_than", "greater_or_equal", "less_than", "less_or_equal", "between", "not_between", "contains", "not_contains", "is_blank", "not_blank", "duplicate", "unique", "top", "bottom", "top_percent", "bottom_percent"}},
		"formula":               map[string]any{"type": "string", "maxLength": 2000},
		"icon_style":            map[string]any{"type": "string", "enum": []string{"3Arrows", "3TrafficLights1", "3Symbols", "4Arrows", "5Arrows", "5Quarters"}},
		"icon_reverse":          map[string]any{"type": "boolean"},
		"value":                 map[string]any{},
